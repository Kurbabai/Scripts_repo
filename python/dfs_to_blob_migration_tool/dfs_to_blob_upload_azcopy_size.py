...
def file_upload_to_blob(account_name, container_name, blob_name, dfs_path, dfs_file_size):
    try:
        ...
        print("dfs File size for " + dfs_path + "is : " + dfs_file_size)
